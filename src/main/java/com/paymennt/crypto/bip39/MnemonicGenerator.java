...
public class MnemonicGenerator {
    ...
    public static byte[] getSeedFromWordlist(String words, String password, Language language) {
    ...
    public static String getWordlist(int entropyLength, Language language) {
        byte[] entropy = secureRandom.generateSeed(entropyLength / 8);
        return getWordlist(entropy, language);
    }

    public static String getWordlist(byte[] entropy, Language language) {
     ...
     * @return
     */
    private static BitSet createBitset(byte[] bytes) {
    ...
    private static int getInt(BitSet range) {
    ...
    private static BitSet append(BitSet a, BitSet b, int bLength) {
    ...
    private static BitSet shift(BitSet bitSet, int length) {
