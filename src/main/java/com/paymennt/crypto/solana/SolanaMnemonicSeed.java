 ...
 * wallet.
 */
public class SolanaMnemonicSeed extends MnemonicSeed {

	/**
	 * {@inheritDoc}
	 */
	public SolanaMnemonicSeed(char[] mnemonicPhrase) {
	 ...
	 * {@inheritDoc}
	 */
	public SolanaMnemonicSeed(char[] mnemonicPhrase, char[] passPhrase) {
	 ...
	 * {@inheritDoc}
	 */
	public SolanaMnemonicSeed(char[] mnemonicPhrase, char[] passPhrase, WordList wordlist) {
	...
	public ExtendedPrivateKey getMasterPrivateKey(String prefix) {
		...
		return ExtendedPrivateKey.from(HMacSha512.hash("ed25519 seed", toSeed()), //
				0, //
				"00000000", //
				BigInteger.ZERO, //
				prefix);
	...
	public ExtendedPublicKey getMasterPublicKey(String prefix) {
		return ExtendedPublicKey.fromPrivateKey(
				//
				HMacSha512.hash("ed25519 seed", toSeed()), //
				0, //
				"00000000", //
				BigInteger.ZERO, //
				prefix);
