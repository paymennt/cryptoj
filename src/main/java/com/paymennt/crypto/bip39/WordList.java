...
public enum WordList {
    ...
    ENGLISH(
        Arrays.asList("abandon", "ability", "able", "about", "above", "absent", "absorb", "abstract", "absurd",
            ...
            "disagree", "discover", "disease", "dish", "dismiss", "disorder", "display", "distance", "divert",
            ...
            "faculty", "fade", "faint", "faith", "fall", "false", "fame", "family", "famous", "fan", "fancy",
            ...
            "hold", "hole", "holiday", "hollow", "home", "honey", "hood", "hope", "horn", "horror", "horse",
            ...
            "melody", "melt", "member", "memory", "mention", "menu", "mercy", "merge", "merit", "merry", "mesh",
            ...
            "okay", "old", "olive", "olympic", "omit", "once", "one", "onion", "online", "only", "open",
            ...
            "range", "rapid", "rare", "rate", "rather", "raven", "raw", "razor", "ready", "real", "reason",
            "rebel", "rebuild", "recall", "receive", "recipe", "record", "recycle", "reduce", "reflect",
            ...
            "tell", "ten", "tenant", "tennis", "tent", "term", "test", "text", "thank", "that", "theme", "then",
            ...
            "web", "wedding", "weekend", "weird", "welcome", "west", "wet", "whale", "what", "wheat", "wheel",
            "when", "where", "whip", "whisper", "wide", "width", "wife", "wild", "will", "win", "window",
    ...
    WordList(List<String> words) {
        this.words = words;
        this.mnemonicTree = new MnemonicTree();
        int i = 0;
        for (String word : words)
            this.mnemonicTree.addPath(Integer.valueOf(i++), word.toCharArray());
    }
    ...
    private class MnemonicTree {
        ...
        public void addPath(Integer leafIndex, char... characters) {
            ...
            for (char c : characters)
                path.addLast(Character.valueOf(c));
        ...
        public void addPath(Integer leafIndex, LinkedList<Character> path) {
            ...
            if (c == null) {
                ...
                if (!this.branches.containsKey(c))
                    this.branches.put(c, new MnemonicTree());
                this.branches.get(c).addPath(leafIndex, path);
            }
        }
        ...
        public Integer getIndex(LinkedList<Character> path) {
            ...
            MnemonicTree branch = this.branches.getOrDefault(path.poll(), null);
            return branch != null ? branch.getIndex(path) : null;
        }
    }
